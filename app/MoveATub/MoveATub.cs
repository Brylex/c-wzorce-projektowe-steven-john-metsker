...
using UserInterface;
    ...
    /// <summary>
    /// Klasa czêœciowo przekszta³cona, z osobn¹ metod¹ dla ka¿dej
    /// kontrolki. Nastêpnym etapem bêdzie utworzenie klasy mediuj¹cej,
    /// wydzielaj¹cej z tej klasy logikê dzia³ania kontrolek.
    /// </summary>
public class MoveATub : Form
{
    ...
    /// <summary>
    /// Utworzenie instancji aplikacji powoduje u³o¿enie i inicjalizacjê
    /// kontrolek GUI.
    /// </summary>
    public MoveATub()
    {
        ...
        Controls.AddRange(new Control[] {                                                        
                                            ...
                                            AssignButton(),
                                            MachineLabel()});
        Text = "Przenoszenie pojemnika";
        foreach (string s in MachineNames())
        {
            MachineList().Items.Add(new ListViewItem(s, 0));
        }
    }
    // Tymczasowe podejœcie w wpisanymi na sztywno litera³ami, ale
    // za to unikaj¹ce uk³adania i dokowania ramek grupuj¹cych.
    private IList Boxes()
    {
    ...
    // inicjalizacja listy nazw maszyn
    ...
    // inicjalizacja tablicy pojemników przy maszynach
    ...
    /// <summary>
    /// Przenosi wybrany pojemnik do wybranej maszyny.
    /// </summary>
    ...
    // metoda pomocnicza tworz¹ca ramkê grupuj¹c¹
